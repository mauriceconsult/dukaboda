  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      >
        ...
        {/* Scooter body */}
        <ellipse cx="20" cy="28" rx="13" ry="5" stroke={bodyColor} strokeWidth="2.5" fill="none"/>
        {/* Wheels */}
        <circle cx="10" cy="31" r="4" stroke={bodyColor} strokeWidth="2" fill="none"/>
        <circle cx="30" cy="31" r="4" stroke={bodyColor} strokeWidth="2" fill="none"/>
        {/* Rider head */}
        <circle cx="27" cy="16" r="5" fill={accentColor}/>
        {/* Speed lines */}
        <line x1="3"  y1="20" x2="9"  y2="20" stroke={accentColor} strokeWidth="2"   strokeLinecap="round"/>
        <line x1="2"  y1="25" x2="7"  y2="25" stroke={accentColor} strokeWidth="1.5" strokeLinecap="round"/>
        <line x1="4"  y1="15" x2="8"  y2="15" stroke={accentColor} strokeWidth="1"   strokeLinecap="round"/>
      </svg>
